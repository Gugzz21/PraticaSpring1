package com.senac.gustavo.config;


import com.senac.gustavo.entity.Funcionario;
import com.senac.gustavo.repository.FuncionarioRepository;
import com.senac.gustavo.service.JwtTokenService;
import com.senac.gustavo.service.UserDetailsImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (checkIfEndpointIsNotPublic(request)) {
            ...
            if (token != null) {
                ...
                Funcionario funcionario = funcionarioRepository.findByMatricula(subject).get(); // Busca o usuário pelo email (que é o assunto do token)
